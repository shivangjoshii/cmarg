...
class PdfReportGenerator {
  static Future<void> generateAndDownloadReport(
    ...
    try {
          ...
          build: (pw.Context context) {
            return pw.Column(
              ...
              children: [
                ...
                // Qualified Colleges Section Header
                pw.Text(
                ...
                // College Item Rows with INR and pipe separator
                _buildPdfCollegeItem(
                ...
                pw.Row(
                  ...
                  children: [
                    pw.Text(
                      'Report Generated on careermarg.com',
                      style: const pw.TextStyle(
      ...
      AppToast.error(
        'Rebuild Required',
        'Please stop and re-run "flutter run" to bind native printing plugins.',
      );
    } catch (e) {
      AppToast.error('Report Error', 'Unable to generate PDF report: $e');
    }
  }
  ...
  static pw.Widget _buildPdfScoreBox(
    String label,
    String value,
    PdfColor color,
  ) {
  ...
  static pw.Widget _buildPdfCollegeItem(
    String name,
    String loc,
    String quota,
    String fee,
